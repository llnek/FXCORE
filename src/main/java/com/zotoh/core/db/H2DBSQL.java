 ...
 *
 */
public class H2DBSQL extends HxxDBSQL {
    
    /**
     * @param args
     */
    public static void main(String[] args)    {
        System.exit( runMain(new H2DBSQL(), args));
    }
    ...
    protected String xxCreateDB(File dbFileDir, String dbid, String user, String pwd) 
        ...
        return H2DB.getInstance().createDB(dbFileDir, dbid, user, pwd);
    }
    ...
    protected void xxLoadSQL(String dbUrl, String user, String pwd, File sql) 
                throws SQLException,IOException {
        H2DB.getInstance().loadSQL(dbUrl, user, pwd, sql);
    }
    ...
    protected void xxCloseDB(String dbUrl, String user, String pwd) 
                throws SQLException,IOException {
        H2DB.getInstance().closeDB(dbUrl, user, pwd);
    }
